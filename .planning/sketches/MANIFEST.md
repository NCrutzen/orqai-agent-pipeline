...
| 008 | detail-pane-stage-scope | Future stages + Approve semantics — full surface stack (header, body, audit per stage, feedback panel, read-back). | _pending_ | phase-82.5, detail-pane, stage-scope, approve-semantics, surface-stack |
