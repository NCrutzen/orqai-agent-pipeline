...
- [x] **FB-09
**: `NeedsActionChip` URL-param toggle wired into stage-0/1/2/3 page.tsx (defaults OFF).
- [x] **FB-10
**: `MineOnlyChip` URL-param toggle filters list to current operator's feedback rows.
- [x] **FB-11
