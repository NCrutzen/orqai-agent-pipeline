...
// Phase 76 Plan 06 Task 2 — Selection context for the Stage 3 Kanban surface.
//
// Mirrors web/app/(dashboard)/automations/[swarm]/review/selection-context.tsx
// shape verbatim (RESEARCH §Pattern 5 — pendingRemovalIds + history.replaceState).
// Adapted for KanbanRow ids; client-side selection updates the URL via
