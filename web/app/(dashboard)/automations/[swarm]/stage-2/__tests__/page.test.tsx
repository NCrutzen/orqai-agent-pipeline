// Phase 3 Plan 03 Task 3 — Stage 2 legacy page is now a redirect to
// `/automations/[swarm]/review` (P3-D-10 + P3-D-12 + REQ-01 success criterion
// #2). The prior unified-shell render assertions are retired; the new
// contract is: this page MUST call next/navigation `redirect()` and MUST NOT
// import option-z-detail-pane.
...
describe("Stage 2 legacy page → Bulk Review redirect (Plan 03 Task 3)", () => {
  it("redirects to /automations/{swarm}/review", async () => {
    await expect(
      Stage2Page({ params: Promise.resolve({ swarm: "debtor-email" }) }),
