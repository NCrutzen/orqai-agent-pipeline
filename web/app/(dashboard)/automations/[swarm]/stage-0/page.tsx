...
//
// Hard-separation lock (docs/agentic-pipeline/README.md): Stage 0 (safety
// filter) sits upstream of and orthogonal to Stage 1 (swarm_noise_categories)
// and Stage 3 (swarm_intents). This redirect file touches neither registry.
