...
ON CONFLICT (email_id, swarm_type, stage) WHERE email_id IS NOT NULL DO NOTHING;  -- 82.8-09: partial unique INDEX (not a CONSTRAINT) requires index-inference syntax
