...
echo ""
echo "== DIST-07: CI scaffolds =="
check_file_exists ".github/workflows/orq-agent-test.yml" "GitHub Actions workflow"
check_file_exists ".gitlab-ci.yml" "GitLab CI template"
check_grep ".github/workflows/orq-agent-test.yml" 'orq-agent:test' "GitHub workflow invokes /orq-agent:test"
check_grep ".github/workflows/orq-agent-test.yml" 'ITRX-04' "GitHub workflow references ITRX-04 regression flag"
